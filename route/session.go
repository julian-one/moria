...
func GetSession(db *sql.DB) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		s, err := session.ByID(r.Context(), db, r.PathValue("id"))
...
func DeleteSession(db *sql.DB) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		if err := session.Delete(r.Context(), db, r.PathValue("id")); err != nil {
...
func DeleteAllSessions(db *sql.DB) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
